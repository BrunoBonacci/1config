...
``` bash
mkdir -p ~/bin
wget https://github.com/BrunoBonacci/1config/releases/download/0.16.2/1cfg -O ~/bin/1cfg
wget https://github.com/BrunoBonacci/1config/releases/download/0.16.2/1cfg-ui-beta -O ~/bin/1cfg-ui-beta
chmod +x ~/bin/1cfg
...
### Windows
 ...
 - Download https://github.com/BrunoBonacci/1config/releases/download/0.16.2/1cfg and save it in the above folder
 - Download https://github.com/BrunoBonacci/1config/releases/download/0.16.2/1cfg-ui-beta and save it in the above folder
